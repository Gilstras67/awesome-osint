...
* [Egidio Threat Lab](https://egidio.app/en/laboratoire/) - Documented dossiers on data breaches and scams affecting France (2025-2026). Every figure is labelled as either officially confirmed by a public authority or merely claimed by an attacker, and the two are never aggregated. Sources cited and dated. Web reference only, no API or bulk download. CC BY 4.0.
